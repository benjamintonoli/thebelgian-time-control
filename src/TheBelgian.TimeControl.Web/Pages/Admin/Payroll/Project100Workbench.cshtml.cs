...
public sealed class Project100WorkbenchModel(
    IPayrollProject100WorkbenchService workbenchService,
    ...
    ILogger<Project100WorkbenchModel> logger) : PageModel
{
    ...
    public PayrollProject100WorkbenchPage? Workbench { get; private set; }
    public IReadOnlyDictionary<string, PayrollProject100GpsCacheHint> GpsHints { get; private set; } =
        new Dictionary<string, PayrollProject100GpsCacheHint>(StringComparer.Ordinal);
    ...
    public async Task<IActionResult> OnGetDetailAsync(string? adminCaseKey, CancellationToken cancellationToken)
    {
        ...
        var hints = new Dictionary<string, PayrollProject100GpsCacheHint>(StringComparer.Ordinal);
        ...
        GpsHints = hints;
        return Partial("_Project100Detail", this);
    }
    ...
    public async Task<IActionResult> OnGetGpsAsync(string adminCaseKey, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            return new JsonResult(new
            {
                ...
                neverValidates = PayrollProject100CaseDetail.GpsNeverValidatesNote,
        ...
        catch (Exception exception)
        {
            ...
            return new JsonResult(new
            {
                ok = true,
                available = false,
                summary = PayrollProject100WorkbenchBuilder.MissingGpsSummary,
                neverValidates = PayrollProject100CaseDetail.GpsNeverValidatesNote,
