...
public sealed class StandbyWorkbenchModel(
    IPayrollStandbyWorkbenchService workbenchService,
    ...
    ILogger<StandbyWorkbenchModel> logger) : PageModel
{
    ...
    public PayrollStandbyWorkbenchPage? Workbench { get; private set; }
    public IReadOnlyDictionary<string, PayrollStandbyGpsCacheHint> GpsHints { get; private set; } =
        new Dictionary<string, PayrollStandbyGpsCacheHint>(StringComparer.Ordinal);
    ...
    public async Task<IActionResult> OnGetDetailAsync(string? adminCaseKey, CancellationToken cancellationToken)
    {
        ...
        var hints = new Dictionary<string, PayrollStandbyGpsCacheHint>(StringComparer.Ordinal);
        ...
        GpsHints = hints;
        return Partial("_StandbyDetail", this);
    }
        ...
        try
        {
            ...
            return new JsonResult(new
            {
                ...
                openCorrection = string.Equals(
                    result.DecisionCode,
                    PayrollGuidedDecisionCodes.StandbyHoursWrong,
    ...
    public async Task<IActionResult> OnGetGpsAsync(string adminCaseKey, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            return new JsonResult(new
            {
                ...
                neverValidates = PayrollStandbyCaseDetail.GpsNeverValidatesNote,
        ...
        catch (Exception exception)
        {
            ...
            return new JsonResult(new
            {
                ok = true,
                available = false,
                summary = PayrollStandbyWorkbenchBuilder.MissingGpsSummary,
                neverValidates = PayrollStandbyCaseDetail.GpsNeverValidatesNote,
