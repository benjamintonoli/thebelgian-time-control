...
public sealed class Project200WorkbenchModel(
    IPayrollProject200WorkbenchService workbenchService,
    ...
    ILogger<Project200WorkbenchModel> logger) : PageModel
{
    ...
    public PayrollProject200WorkbenchPage? Workbench { get; private set; }
    public IReadOnlyDictionary<string, PayrollProject200GpsCacheHint> GpsHints { get; private set; } =
        new Dictionary<string, PayrollProject200GpsCacheHint>(StringComparer.Ordinal);
    ...
    public async Task<IActionResult> OnGetDetailAsync(string? adminCaseKey, CancellationToken cancellationToken)
    {
        ...
        var hints = new Dictionary<string, PayrollProject200GpsCacheHint>(StringComparer.Ordinal);
        ...
        GpsHints = hints;
        return Partial("_Project200Detail", this);
    }
    ...
    public async Task<IActionResult> OnGetGpsAsync(string adminCaseKey, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            return new JsonResult(new
            {
                ...
                neverValidates = PayrollProject200CaseDetail.GpsNeverValidatesNote,
        ...
        catch (Exception exception)
        {
            ...
            return new JsonResult(new
            {
                ok = true,
                available = false,
                summary = PayrollProject200WorkbenchBuilder.MissingGpsSummary,
                neverValidates = PayrollProject200CaseDetail.GpsNeverValidatesNote,
