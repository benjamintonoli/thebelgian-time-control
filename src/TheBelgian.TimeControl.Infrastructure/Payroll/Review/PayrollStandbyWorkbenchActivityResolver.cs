...
/// <summary>
/// Resolves PWS ExpectedActivityType for Standby corrections using the same
...
/// </summary>
internal static class PayrollStandbyWorkbenchActivityResolver
{
        ...
        HfdTaakDefinition? hfdTaak)
    {
        ...
        var pilot = new NormalizedPilotPerformance(
            ...
            JoinAssessment: "standby-workbench",
            Normalization: "standby-workbench");
