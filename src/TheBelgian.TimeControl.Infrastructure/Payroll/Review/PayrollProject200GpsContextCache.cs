...
/// </summary>
internal sealed class PayrollProject200GpsContextCache
{
    private static readonly TimeSpan Ttl = TimeSpan.FromMinutes(30);
    private readonly ConcurrentDictionary<string, Entry> _entries = new(StringComparer.Ordinal);

    public bool TryGet(string adminCaseKey, out PayrollProject200GpsContext? context)
    {
    ...
    public void Set(string adminCaseKey, PayrollProject200GpsContext context)
    {
    ...
    private sealed record Entry(PayrollProject200GpsContext Context, DateTimeOffset ExpiresAtUtc);
}
