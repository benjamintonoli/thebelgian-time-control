...
/// <summary>
/// Resolves PWS ExpectedActivityType for Project200 corrections using the same
...
/// </summary>
internal static class PayrollProject200ActivityResolver
{
        ...
        HfdTaakDefinition? hfdTaak)
    {
        ...
        var pilot = new NormalizedPilotPerformance(
            ...
            JoinAssessment: "project200-workbench",
            Normalization: "project200-workbench");
