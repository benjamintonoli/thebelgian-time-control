...
/// </summary>
internal sealed class PayrollProject300GpsContextCache
{
    private static readonly TimeSpan Ttl = TimeSpan.FromMinutes(30);
    private readonly ConcurrentDictionary<string, Entry> _entries = new(StringComparer.Ordinal);

    public bool TryGet(string adminCaseKey, out PayrollProject300GpsContext? context)
    {
    ...
    public void Set(string adminCaseKey, PayrollProject300GpsContext context)
    {
    ...
    private sealed record Entry(PayrollProject300GpsContext Context, DateTimeOffset ExpiresAtUtc);
}
