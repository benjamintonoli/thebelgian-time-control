...
/// <summary>
/// Resolves PWS ExpectedActivityType for Project100 corrections using the same
...
/// </summary>
internal static class PayrollProject100ActivityResolver
{
        ...
        HfdTaakDefinition? hfdTaak)
    {
        ...
        var pilot = new NormalizedPilotPerformance(
            ...
            JoinAssessment: "project100-workbench",
            Normalization: "project100-workbench");
