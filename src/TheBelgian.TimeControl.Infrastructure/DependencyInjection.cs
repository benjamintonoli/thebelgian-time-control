...
public static class DependencyInjection
{
        ...
        IConfiguration configuration)
    {
        ...
        services.AddSingleton<PayrollProject300QueueCache>();
        services.AddSingleton<PayrollProject300BonMemoCache>();
        services.AddSingleton<PayrollProject300MonthContextCache>();
        services.AddSingleton<PayrollProject300HfdCache>();
        services.AddScoped<IPayrollProject300WorkbenchService, PayrollProject300WorkbenchService>();
        services.AddSingleton<PayrollProject200GpsCache>();
        services.AddSingleton<PayrollProject200GpsContextCache>();
        services.AddSingleton<PayrollProject200DaySourceCache>();
        services.AddSingleton<PayrollProject200QueueCache>();
        services.AddSingleton<PayrollProject200BonMemoCache>();
        ...
        services.AddSingleton<PayrollProject100GpsCache>();
        services.AddSingleton<PayrollProject100GpsContextCache>();
        services.AddSingleton<PayrollProject100DaySourceCache>();
        services.AddSingleton<PayrollProject100QueueCache>();
        services.AddSingleton<PayrollProject100BonMemoCache>();
        services.AddSingleton<PayrollProject100MonthContextCache>();
        services.AddSingleton<PayrollProject100HfdCache>();
        services.AddScoped<IPayrollProject100WorkbenchService, PayrollProject100WorkbenchService>();
        ...
        services.AddSingleton<PayrollIntelligenceQueueCache>();
        services.AddSingleton<PayrollIntelligenceDayCache>();
        services.AddSingleton<PayrollIntelligenceGpsCache>();
        services.AddSingleton<PayrollIntelligenceGpsContextCache>();
        services.AddSingleton<PayrollIntelligenceHfdCache>();
        services.AddScoped<IPayrollIntelligenceWorkbenchService, PayrollIntelligenceWorkbenchService>();
        return services;
    }
